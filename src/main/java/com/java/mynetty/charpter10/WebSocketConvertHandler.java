...
import com.java.mynetty.charpter10.WebSocketConvertHandler.MyWebSocketFrame.FrameType;
import com.java.mynetty.charpter10.WebSocketConvertHandler.MyWebSocketFrame;
...
public class WebSocketConvertHandler extends MessageToMessageCodec<WebSocketFrame, MyWebSocketFrame> {
	...
	protected void encode(ChannelHandlerContext ctx, MyWebSocketFrame msg, List<Object> out) throws Exception {
		...
		default:
			throw new IllegalStateException(
					"Unsupported web socket msg " + msg);
		}
	}
	...
	protected void decode(ChannelHandlerContext ctx, WebSocketFrame msg, List<Object> out) throws Exception {
		...
		{
			throw new IllegalStateException("Unsupport websocket msg" + msg);
		}
	}
